...
fasttext-langdetect
    ...
    version: 1.0.5
project_url: https://pypi.org/project/fasttext-langdetect/
fasttext-langdetect-wheel
    summary: 80x faster and 95% accurate language identification with Fasttext
    version: 1.0.5
project_url: https://pypi.org/project/fasttext-langdetect-wheel/
fasttext-language-detection
    summary: Language detection wrapper with fasttext
    version: 0.4
project_url: https://pypi.org/project/fasttext-language-detection/
fasttext-numpy2
    summary: fasttext Python bindings, fixed numpy 2 compatibiliy
    version: 0.10.4
project_url: https://pypi.org/project/fasttext-numpy2/
fasttext-numpy2-wheel
    summary: fasttext Python bindings
    version: 0.9.2
project_url: https://pypi.org/project/fasttext-numpy2-wheel/
fasttext-parallel
    summary: FastText Multithreading Inference
    version: 0.1.4
project_url: https://pypi.org/project/fasttext-parallel/
fasttext-predict
...
fasttextannotator
    ...
    version: 1.0.0
project_url: https://pypi.org/project/fasttextannotator/
fasttextaug
    summary: None
    version: 0.1.1
...
FastTextRank
    ...
    version: 1.4
project_url: https://pypi.org/project/FastTextRank/
fasttextsearch
